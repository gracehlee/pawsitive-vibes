    ...
    async function handleFormSubmit(e) {
        ...
        try {
            ...
            if (response.ok) {
                ...
                setUserError('Error updating user information.')
            }
        } catch (error) {
            setUserError(`Error updating user information: ${error}`)
        }

        if (!user) {
            setUserError('User update failed. Please check username or email.')
        }
    }
